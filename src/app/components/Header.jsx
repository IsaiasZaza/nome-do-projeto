...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-black text-white shadow mx-auto w-full border-none">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
        <div className="flex items-center">
          <h1 className='italic text-3xl font-bold text-green-500'>PerfilNoAr</h1>
        </div>
          ...
          <nav>
            <ul className="flex space-x-4">
              <li>
                <Link to="section1"
                  smooth={true}
                  duration={500} className="text-white hover:text-orange-500">
                  Como Doar
                </Link>
              </li>
              <li>
        ...
        <nav>
          <ul className="space-y-2 px-4 py-2">
            <li>
              <Link to="section1"
                smooth={true}
                duration={500} className="block px-4 py-2 text-white hover:text-yellow-500">
                Torne-se Afiliado
              </Link>
            </li>
            <li>
